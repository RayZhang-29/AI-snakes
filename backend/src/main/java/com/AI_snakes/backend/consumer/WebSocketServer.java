package com.AI_snakes.backend.consumer;
...
public class WebSocketServer {
    ...
    final private static ConcurrentHashMap<Integer, WebSocketServer> users = new ConcurrentHashMap<>(); // static: global
    ...
    @OnMessage
    public void onMessage(String message, Session session) { // like a router
    ...
    public void sendMessage(String messsage) {
        synchronized (this.session) {
            try {
                this.session.getBasicRemote().sendText(messsage);
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
