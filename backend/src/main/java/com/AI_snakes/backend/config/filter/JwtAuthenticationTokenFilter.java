package com.AI_snakes.backend.config.filter;
...
import com.AI_snakes.backend.utils.JwtUtil;
...
// verify jwt token, if verified, inject user info into the context(database, client)
@Component
